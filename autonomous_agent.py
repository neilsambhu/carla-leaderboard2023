...
class AutonomousAgent(object):
    ...
    def __call__(self):
        ...
        if bVerbose:
            pass
            # print(f'type(input_data["Left"][0]): {type(input_data["Left"][0])}\ttype(input_data["Left"][1]): {type(input_data["Left"][1])}')
            import numpy as np
            # print(f'np.shape(input_data["Left"][1]): {np.shape(input_data["Left"][1])}')
            # print(f'input_data["Left"][0]: {input_data["Left"][0]}\tinput_data["Left"][1]: {input_data["Left"][1]}')
            # Access the sensor data and convert it to an RGB numpy array
            frame_global_context = input_data["Left"][0]
            image_data = input_data["Left"][1]
            ...
            im.save(f'frames/img_{frame_global_context:08}.jpeg')
