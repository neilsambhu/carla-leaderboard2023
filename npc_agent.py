    ...
    def run_step(self, input_data, timestamp):
        ...
        if not self._agent:
            ...
            if not hero_actor:
                if bVerbose:
                    pass
                    print(f'1 carla.VehicleControl(): {carla.VehicleControl()}\ttype(carla.VehicleControl()): {type(carla.VehicleControl())}')
            ...
            if bVerbose:
                pass
                print(f'2 carla.VehicleControl(): {carla.VehicleControl()}\ttype(carla.VehicleControl()): {type(carla.VehicleControl())}')
            return carla.VehicleControl()
